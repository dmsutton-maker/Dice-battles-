...
export default async function HomePage() {
  ...
  const aboutBody = text(
    content,
    'home.about_body',
    "We're a small, independent studio making colorful, considered games built to be played together — across a kitchen table, a couch, or a video call. Easy enough to pick up in a minute, whether you're five or eighty-five. No accounts to sign up for and nothing tracked.",
  );
