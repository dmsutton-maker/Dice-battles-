...
export const ARENA_THEMES: Record<ThemedArenaId, ArenaTheme> = {
  ...
  cavern: {
    ...
    */
    ...
    sky: { sun: null, stars: false, body: null },
    props: [
      { kind: 'crystal', x: -3.44, z: -7.3, scale: 0.85, color: '#c98aff' },
      { kind: 'crystal', x: -3.38, z: -3.4, scale: 0.65, color: '#a37ae8' },
      { kind: 'mushroom', x: -3.46, z: -0.8, scale: 0.75, color: '#7fd4e8' },
      { kind: 'crystal', x: -3.4, z: 1.6, scale: 0.7, color: '#dcaeff' },
      { kind: 'rock', x: -3.46, z: 3.5, scale: 0.75, color: '#584a6e' },
      { kind: 'torch', x: 3.42, z: -7.3, scale: 0.75, color: '#ffb04a' },
      { kind: 'crystal', x: 3.38, z: -3.4, scale: 0.8, color: '#c98aff' },
      { kind: 'crystal', x: 3.46, z: -0.8, scale: 0.55, color: '#f0d68a' },
      { kind: 'mushroom', x: 3.4, z: 1.6, scale: 0.7, color: '#7fd4e8' },
      { kind: 'torch', x: 3.46, z: 3.5, scale: 0.7, color: '#ffb04a' },
      { kind: 'crystal', x: -2.4, z: -8.8, scale: 0.6, color: '#a37ae8' },
      { kind: 'pebbles', x: 0.1, z: -9, scale: 0.9, color: '#584a6e' },
      { kind: 'crystal', x: 2.5, z: -8.8, scale: 0.55, color: '#dcaeff' },
    ],
    look: look(
  ...
  sky: {
    ...
    props: [
      ...
      { kind: 'cloudIsle', x: -3.5, z: -0.9, scale: 0.42 },
      ...
      { kind: 'cloudIsle', x: 3.44, z: -3.3, scale: 0.46 },
      { kind: 'banner', x: 3.46, z: -0.9, scale: 0.75, color: '#ffd21f' },
      { kind: 'cloudIsle', x: 3.5, z: 1.6, scale: 0.42 },
      { kind: 'flowers', x: 3.46, z: 3.6, scale: 0.9, color: '#ff8ab0' },
      { kind: 'cloudIsle', x: -2.4, z: -8.8, scale: 0.4 },
      { kind: 'balloon', x: 0.1, z: -9, scale: 0.5, color: '#ffd21f' },
      { kind: 'cloudIsle', x: 2.5, z: -8.8, scale: 0.38 },
    ],
    look: look(
  ...
  moon: {
    ...
    props: [
      ...
      { kind: 'moonRock', x: -3.46, z: -0.8, scale: 0.55 },
      { kind: 'pebbles', x: -3.4, z: 1.6, scale: 0.95, color: '#a3a7b0' },
      { kind: 'banner', x: -3.46, z: 3.5, scale: 0.75, color: '#3f7fd0' },
      { kind: 'lantern', x: 3.42, z: -7.3, scale: 0.85, color: '#ffd21f' },
      { kind: 'moonRock', x: 3.38, z: -3.4, scale: 0.65 },
      { kind: 'pebbles', x: 3.46, z: -0.8, scale: 0.9, color: '#9a9eaa' },
      { kind: 'moonRock', x: 3.4, z: 1.6, scale: 0.5 },
      { kind: 'lantern', x: 3.46, z: 3.5, scale: 0.8, color: '#ffd21f' },
      { kind: 'moonRock', x: -2.4, z: -8.8, scale: 0.6 },
      { kind: 'pebbles', x: 0.1, z: -9, scale: 0.9, color: '#a3a7b0' },
  ...
  farm: {
    ...
    sky: { sun: { color: '#fff6d8', size: 1.6 }, stars: false, body: null },
    props: [
      { kind: 'barn', x: -3.5, z: -7.3, scale: 0.42 },
      { kind: 'roundTree', x: -3.38, z: -3.4, scale: 0.58, color: '#5c9e3d' },
      { kind: 'hayBale', x: -3.46, z: -0.8, scale: 0.9 },
      { kind: 'flowers', x: -3.4, z: 1.6, scale: 0.95, color: '#ffd21f' },
      { kind: 'bush', x: -3.46, z: 3.5, scale: 0.9, color: '#5c9e3d' },
      { kind: 'roundTree', x: 3.42, z: -7.3, scale: 0.6, color: '#6eb34a' },
      { kind: 'hayBale', x: 3.38, z: -3.4, scale: 0.85 },
      { kind: 'roundTree', x: 3.46, z: -0.8, scale: 0.52, color: '#5c9e3d' },
      { kind: 'flowers', x: 3.4, z: 1.6, scale: 0.9, color: '#ff6e6e' },
      { kind: 'hayBale', x: 3.46, z: 3.5, scale: 0.8 },
      { kind: 'bush', x: -2.4, z: -8.8, scale: 0.85, color: '#6eb34a' },
      { kind: 'hayBale', x: 0.1, z: -9, scale: 0.8 },
  ...
  reef: {
    ...
    props: [
      ...
      { kind: 'coral', x: -3.46, z: -0.8, scale: 0.7, color: '#ff6e9e' },
      { kind: 'pebbles', x: -3.4, z: 1.6, scale: 0.95, color: '#125460' },
      { kind: 'coral', x: -3.46, z: 3.5, scale: 0.65, color: '#8ad4e8' },
      { kind: 'coral', x: 3.42, z: -7.3, scale: 0.8, color: '#ffc95c' },
      { kind: 'rock', x: 3.38, z: -3.4, scale: 0.7, color: '#125460' },
      { kind: 'seaweed', x: 3.46, z: -0.8, scale: 0.85 },
      { kind: 'coral', x: 3.4, z: 1.6, scale: 0.72, color: '#ff8a5c' },
      { kind: 'seaweed', x: 3.46, z: 3.5, scale: 0.75 },
      { kind: 'coral', x: -2.4, z: -8.8, scale: 0.6, color: '#ff6e9e' },
      { kind: 'pebbles', x: 0.1, z: -9, scale: 0.9, color: '#125460' },
      { kind: 'coral', x: 2.5, z: -8.8, scale: 0.55, color: '#ffc95c' },
    ],
    look: look(
  ...
  city: {
    ...
    */
    ...
    props: [
      { kind: 'cityTower', x: -3.5, z: -7.3, scale: 0.42 },
      { kind: 'lantern', x: -3.38, z: -3.4, scale: 0.85, color: '#ffc95c' },
      { kind: 'bush', x: -3.46, z: -0.8, scale: 0.85, color: '#3a6b4a' },
      { kind: 'cityTower', x: -3.5, z: 1.6, scale: 0.36 },
      { kind: 'banner', x: -3.46, z: 3.5, scale: 0.75, color: '#ffc95c' },
      { kind: 'cityTower', x: 3.5, z: -7.3, scale: 0.46 },
      { kind: 'bush', x: 3.38, z: -3.4, scale: 0.85, color: '#3a6b4a' },
      { kind: 'lantern', x: 3.46, z: -0.8, scale: 0.85, color: '#ffc95c' },
      { kind: 'cityTower', x: 3.5, z: 1.6, scale: 0.34 },
      { kind: 'pebbles', x: 3.46, z: 3.5, scale: 0.9, color: '#4c5170' },
      { kind: 'cityTower', x: -2.4, z: -8.8, scale: 0.4 },
      { kind: 'lantern', x: 0.1, z: -9, scale: 0.7, color: '#ffc95c' },
      { kind: 'cityTower', x: 2.5, z: -8.8, scale: 0.38 },
    ],
    look: look(
